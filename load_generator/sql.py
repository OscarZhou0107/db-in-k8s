...
if __name__ == "__main__":
    ...
    {"request_msql_text": {"tableops": "READ item orderline orders author '", "op": "begin_tx"}}
        getRelated    :    ['item']
        getBestSellers    :    ['item', 'orderline', 'orders', 'author']
    searchResult
    {"request_msql_text": {"tableops": "READ item author '", "op": "begin_tx"}}
        getRelated    :    ['item']
